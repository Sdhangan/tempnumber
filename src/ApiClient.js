...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://tn-api.com/api/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://tn-api.com/api/v1
         */
        ...
        this.authentications = {
            'apikey_auth': {type: 'apiKey', 'in': 'header', name: 'x-api-key'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.3.8/Javascript'
        };
