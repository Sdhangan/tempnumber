...
export default class UserApi {
    ...
    */
     ...
     * Get user's balance
     * Get user's balance
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UserBalance} and HTTP response
     */
    getUserBalanceWithHttpInfo() {
      let postBody = null;
     ...
     * Get user's balance
     * Get user's balance
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/UserBalance}
     */
    getUserBalance() {
      return this.getUserBalanceWithHttpInfo()
