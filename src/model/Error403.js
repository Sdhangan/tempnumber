...
class Error403 {
     ...
     * @param errorName {module:model/Error403.ErrorNameEnum} Error name
     * @param errorMessage {String} Error message
     */
    constructor(errorName, errorMessage) { 
        
        Error403.initialize(this, errorName, errorMessage);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Error403</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Error403</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Error403.RequiredProperties) {
            if (!data[property]) {
...
Error403.RequiredProperties = ["errorName", "errorMessage"];

/**
 * Error name
 * @member {module:model/Error403.ErrorNameEnum} errorName
 */
Error403.prototype['errorName'] = undefined;

/**
 * Error message
 * @member {String} errorMessage
 */
Error403.prototype['errorMessage'] = undefined;
 ...
 * @readonly
 */
Error403['ErrorNameEnum'] = {

    /**
     * value: "AccountOnHoldException"
     * @const
     */
    "AccountOnHoldException": "AccountOnHoldException"
};
