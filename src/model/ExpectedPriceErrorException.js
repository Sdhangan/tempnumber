...
/**
 * The ExpectedPriceErrorException model module.
 * @module model/ExpectedPriceErrorException
 * @version 1.3.8
 */
class ExpectedPriceErrorException {
    /**
     * Constructs a new <code>ExpectedPriceErrorException</code>.
     * @alias module:model/ExpectedPriceErrorException
     * @param errorMessage {String} Price has changed
     * @param errorName {module:model/ExpectedPriceErrorException.ErrorNameEnum} 
     * @param newPrice {Number} The value of the new price
     */
    constructor(errorMessage, errorName, newPrice) { 
        
        ExpectedPriceErrorException.initialize(this, errorMessage, errorName, newPrice);
    }
     ...
     */
    static initialize(obj, errorMessage, errorName, newPrice) { 
    ...
    /**
     * Constructs a <code>ExpectedPriceErrorException</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExpectedPriceErrorException} obj Optional instance to populate.
     * @return {module:model/ExpectedPriceErrorException} The populated <code>ExpectedPriceErrorException</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExpectedPriceErrorException();
            ...
            if (data.hasOwnProperty('newPrice')) {
                obj['newPrice'] = ApiClient.convertToType(data['newPrice'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExpectedPriceErrorException</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExpectedPriceErrorException</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExpectedPriceErrorException.RequiredProperties) {
            if (!data[property]) {
...
ExpectedPriceErrorException.RequiredProperties = ["errorMessage", "errorName", "newPrice"];

/**
 * Price has changed
 * @member {String} errorMessage
 */
ExpectedPriceErrorException.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/ExpectedPriceErrorException.ErrorNameEnum} errorName
 */
ExpectedPriceErrorException.prototype['errorName'] = undefined;

/**
 * The value of the new price
 * @member {Number} newPrice
 */
ExpectedPriceErrorException.prototype['newPrice'] = undefined;
 ...
 * @readonly
 */
ExpectedPriceErrorException['ErrorNameEnum'] = {

    /**
     * value: "expectedPriceErrorException"
     * @const
     */
    "expectedPriceErrorException": "expectedPriceErrorException"
};



export default ExpectedPriceErrorException;
