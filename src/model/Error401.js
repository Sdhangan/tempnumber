...
class Error401 {
     ...
     * @param errorName {module:model/Error401.ErrorNameEnum} Error name
     * @param errorMessage {String} Error message
     */
    constructor(errorName, errorMessage) { 
        
        Error401.initialize(this, errorName, errorMessage);
    }
...
Error401.RequiredProperties = ["errorName", "errorMessage"];

/**
 * Error name
 * @member {module:model/Error401.ErrorNameEnum} errorName
 */
Error401.prototype['errorName'] = undefined;

/**
 * Error message
 * @member {String} errorMessage
 */
Error401.prototype['errorMessage'] = undefined;
