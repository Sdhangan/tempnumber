...
class Response200 {
     ...
     * @param result {module:model/Response200.ResultEnum} success response
     */
    constructor(result) { 
        
        Response200.initialize(this, result);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Response200.RequiredProperties) {
            if (!data[property]) {
...
Response200.RequiredProperties = ["result"];

/**
 * success response
 * @member {module:model/Response200.ResultEnum} result
 */
Response200.prototype['result'] = undefined;
