...
/**
 * The Error409 model module.
 * @module model/Error409
 * @version 1.3.8
 */
class Error409 {
    /**
     * Constructs a new <code>Error409</code>.
     * @alias module:model/Error409
     * @param errorMessage {String} Resource is in a bad state
     * @param errorName {module:model/Error409.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        Error409.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>Error409</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Error409} obj Optional instance to populate.
     * @return {module:model/Error409} The populated <code>Error409</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Error409();
    ...
    /**
     * Validates the JSON data with respect to <code>Error409</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Error409</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Error409.RequiredProperties) {
            if (!data[property]) {
...
Error409.RequiredProperties = ["errorMessage", "errorName"];

/**
 * Resource is in a bad state
 * @member {String} errorMessage
 */
Error409.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/Error409.ErrorNameEnum} errorName
 */
Error409.prototype['errorName'] = undefined;
 ...
 * @readonly
 */
Error409['ErrorNameEnum'] = {

    /**
     * value: "ResourceBadStateException"
     * @const
     */
    "ResourceBadStateException": "ResourceBadStateException"
};
