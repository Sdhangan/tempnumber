...
/**
 * The SingleService model module.
 * @module model/SingleService
 * @version 1.3.8
 */
class SingleService {
    /**
     * Constructs a new <code>SingleService</code>.
     * @alias module:model/SingleService
     */
    constructor() { 
        
        SingleService.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SingleService</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SingleService} obj Optional instance to populate.
     * @return {module:model/SingleService} The populated <code>SingleService</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SingleService();
    ...
    /**
     * Validates the JSON data with respect to <code>SingleService</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SingleService</code>.
     */
    static validateJSON(data) {
        ...
        if (data['services']) { // data not null
            ...
            for (const item of data['services']) {
                Service.validateJsonObject(item);
            };
        }
 ...
 */
SingleService.prototype['iconBaseUrl'] = undefined;

/**
 * @member {Array.<module:model/Service>} services
 */
SingleService.prototype['services'] = undefined;
