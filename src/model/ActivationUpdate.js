...
/**
 * The ActivationUpdate model module.
 * @module model/ActivationUpdate
 * @version 1.3.8
 */
class ActivationUpdate {
    /**
     * Constructs a new <code>ActivationUpdate</code>.
     * @alias module:model/ActivationUpdate
     * @param status {module:model/ActivationUpdate.StatusEnum} Update status of active number. <br> <b>retry</b> - request another code (free)
     */
    constructor(status) { 
        
        ActivationUpdate.initialize(this, status);
    }
    ...
    /**
     * Constructs a <code>ActivationUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActivationUpdate} obj Optional instance to populate.
     * @return {module:model/ActivationUpdate} The populated <code>ActivationUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActivationUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>ActivationUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActivationUpdate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActivationUpdate.RequiredProperties) {
            if (!data[property]) {
...
ActivationUpdate.RequiredProperties = ["status"];

/**
 * Update status of active number. <br> <b>retry</b> - request another code (free)
 * @member {module:model/ActivationUpdate.StatusEnum} status
 */
ActivationUpdate.prototype['status'] = undefined;
