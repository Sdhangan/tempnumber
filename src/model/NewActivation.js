...
/**
 * The NewActivation model module.
 * @module model/NewActivation
 * @version 1.3.8
 */
class NewActivation {
    /**
     * Constructs a new <code>NewActivation</code>.
     * @alias module:model/NewActivation
     * @param countryId {String} Country id (ISO-3166-1-alpha-2)
     * @param serviceId {String} Service Id. e.g. Facebook, Viber, Whatsapp, etc.
     */
    constructor(countryId, serviceId) { 
        
        NewActivation.initialize(this, countryId, serviceId);
    }
     ...
     */
    static initialize(obj, countryId, serviceId) { 
        obj['countryId'] = countryId;
        obj['serviceId'] = serviceId;
    }

    /**
     * Constructs a <code>NewActivation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewActivation} obj Optional instance to populate.
     * @return {module:model/NewActivation} The populated <code>NewActivation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewActivation();
            ...
            if (data.hasOwnProperty('expectedPrice')) {
                obj['expectedPrice'] = ApiClient.convertToType(data['expectedPrice'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NewActivation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewActivation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewActivation.RequiredProperties) {
            if (!data[property]) {
...
NewActivation.RequiredProperties = ["countryId", "serviceId"];

/**
 * Country id (ISO-3166-1-alpha-2)
 * @member {String} countryId
 */
NewActivation.prototype['countryId'] = undefined;

/**
 * Service Id. e.g. Facebook, Viber, Whatsapp, etc.
 * @member {String} serviceId
 */
NewActivation.prototype['serviceId'] = undefined;

/**
 * Expected price
 * @member {Number} expectedPrice
 */
NewActivation.prototype['expectedPrice'] = undefined;
