...
/**
 * The AccountOnHold model module.
 * @module model/AccountOnHold
 * @version 1.2.7
 */
class AccountOnHold {
    /**
     * Constructs a new <code>AccountOnHold</code>.
     * @alias module:model/AccountOnHold
     * @param errorMessage {String} Account is in on hold state
     * @param errorName {module:model/AccountOnHold.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        AccountOnHold.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>AccountOnHold</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountOnHold} obj Optional instance to populate.
     * @return {module:model/AccountOnHold} The populated <code>AccountOnHold</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountOnHold();
...
/**
 * Account is in on hold state
 * @member {String} errorMessage
 */
AccountOnHold.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/AccountOnHold.ErrorNameEnum} errorName
 */
AccountOnHold.prototype['errorName'] = undefined;
