...
/**
 * The ActivationsHistory model module.
 * @module model/ActivationsHistory
 * @version 1.3.8
 */
class ActivationsHistory {
    /**
     * Constructs a new <code>ActivationsHistory</code>.
     * @alias module:model/ActivationsHistory
     */
    constructor() { 
        
        ActivationsHistory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActivationsHistory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActivationsHistory} obj Optional instance to populate.
     * @return {module:model/ActivationsHistory} The populated <code>ActivationsHistory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActivationsHistory();

            if (data.hasOwnProperty('activations')) {
                obj['activations'] = ApiClient.convertToType(data['activations'], [ActivationData]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ActivationsHistory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActivationsHistory</code>.
     */
    static validateJSON(data) {
        if (data['activations']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['activations'])) {
                throw new Error("Expected the field `activations` to be an array in the JSON data but got " + data['activations']);
            }
            // validate the optional field `activations` (array)
            for (const item of data['activations']) {
                ActivationData.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ActivationData>} activations
 */
ActivationsHistory.prototype['activations'] = undefined;

/**
 * Selected page
 * @member {Number} page
 */
ActivationsHistory.prototype['page'] = undefined;

/**
 * Items limit per page
 * @member {Number} limit
 */
ActivationsHistory.prototype['limit'] = undefined;

/**
 * Total pages count
 * @member {Number} pages
 */
ActivationsHistory.prototype['pages'] = undefined;

/**
 * Total records found
 * @member {Number} total
 */
ActivationsHistory.prototype['total'] = undefined;
...
export default ActivationsHistory;
