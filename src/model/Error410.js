...
/**
 * The Error410 model module.
 * @module model/Error410
 * @version 1.3.8
 */
class Error410 {
    /**
     * Constructs a new <code>Error410</code>.
     * @alias module:model/Error410
     * @param errorMessage {String} The target resource is no longer available
     * @param errorName {module:model/Error410.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        Error410.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>Error410</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Error410} obj Optional instance to populate.
     * @return {module:model/Error410} The populated <code>Error410</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Error410();
    ...
    /**
     * Validates the JSON data with respect to <code>Error410</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Error410</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Error410.RequiredProperties) {
            if (!data[property]) {
...
Error410.RequiredProperties = ["errorMessage", "errorName"];

/**
 * The target resource is no longer available
 * @member {String} errorMessage
 */
Error410.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/Error410.ErrorNameEnum} errorName
 */
Error410.prototype['errorName'] = undefined;
