...
/**
 * The TooManyActivationsPending model module.
 * @module model/TooManyActivationsPending
 * @version 1.2.7
 */
class TooManyActivationsPending {
    /**
     * Constructs a new <code>TooManyActivationsPending</code>.
     * @alias module:model/TooManyActivationsPending
     * @param errorMessage {String} Too many activations pending
     * @param errorName {module:model/TooManyActivationsPending.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        TooManyActivationsPending.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>TooManyActivationsPending</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TooManyActivationsPending} obj Optional instance to populate.
     * @return {module:model/TooManyActivationsPending} The populated <code>TooManyActivationsPending</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TooManyActivationsPending();
 ...
 */
TooManyActivationsPending.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/TooManyActivationsPending.ErrorNameEnum} errorName
 */
TooManyActivationsPending.prototype['errorName'] = undefined;
 ...
 * @readonly
 */
TooManyActivationsPending['ErrorNameEnum'] = {
...
export default TooManyActivationsPending;
