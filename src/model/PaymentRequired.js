...
/**
 * The PaymentRequired model module.
 * @module model/PaymentRequired
 * @version 1.2.7
 */
class PaymentRequired {
    /**
     * Constructs a new <code>PaymentRequired</code>.
     * @alias module:model/PaymentRequired
     * @param errorMessage {String} Payment required
     * @param errorName {module:model/PaymentRequired.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        PaymentRequired.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>PaymentRequired</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentRequired} obj Optional instance to populate.
     * @return {module:model/PaymentRequired} The populated <code>PaymentRequired</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentRequired();
 ...
 */
PaymentRequired.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/PaymentRequired.ErrorNameEnum} errorName
 */
PaymentRequired.prototype['errorName'] = undefined;
