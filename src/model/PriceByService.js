...
import PriceByServiceCountries from './PriceByServiceCountries';

/**
 * The PriceByService model module.
 * @module model/PriceByService
 * @version 1.2.7
 */
class PriceByService {
    /**
     * Constructs a new <code>PriceByService</code>.
     * @alias module:model/PriceByService
     */
    constructor() { 
        
        PriceByService.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PriceByService</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PriceByService} obj Optional instance to populate.
     * @return {module:model/PriceByService} The populated <code>PriceByService</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PriceByService();

            if (data.hasOwnProperty('s')) {
                obj['s'] = ApiClient.convertToType(data['s'], 'String');
            }
            if (data.hasOwnProperty('countries')) {
                obj['countries'] = ApiClient.convertToType(data['countries'], [PriceByServiceCountries]);
            }
        }
        return obj;
    }
 ...
 * @member {String} s
 */
PriceByService.prototype['s'] = undefined;

/**
 * @member {Array.<module:model/PriceByServiceCountries>} countries
 */
PriceByService.prototype['countries'] = undefined;
