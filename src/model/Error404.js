...
class Error404 {
     ...
     * @param errorName {module:model/Error404.ErrorNameEnum} Error name
     * @param errorMessage {String} Error message
     */
    constructor(errorName, errorMessage) { 
        
        Error404.initialize(this, errorName, errorMessage);
    }
...
Error404.RequiredProperties = ["errorName", "errorMessage"];

/**
 * Error name
 * @member {module:model/Error404.ErrorNameEnum} errorName
 */
Error404.prototype['errorName'] = undefined;

/**
 * Error message
 * @member {String} errorMessage
 */
Error404.prototype['errorMessage'] = undefined;
