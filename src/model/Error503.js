...
/**
 * The Error503 model module.
 * @module model/Error503
 * @version 1.3.8
 */
class Error503 {
    /**
     * Constructs a new <code>Error503</code>.
     * @alias module:model/Error503
     * @param errorMessage {String} Service Unavailable
     * @param errorName {module:model/Error503.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        Error503.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>Error503</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Error503} obj Optional instance to populate.
     * @return {module:model/Error503} The populated <code>Error503</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Error503();
    ...
    /**
     * Validates the JSON data with respect to <code>Error503</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Error503</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Error503.RequiredProperties) {
            if (!data[property]) {
...
Error503.RequiredProperties = ["errorMessage", "errorName"];

/**
 * Service Unavailable
 * @member {String} errorMessage
 */
Error503.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/Error503.ErrorNameEnum} errorName
 */
Error503.prototype['errorName'] = undefined;
