...
/**
 * The TooManyActivationsPendingException model module.
 * @module model/TooManyActivationsPendingException
 * @version 1.3.8
 */
class TooManyActivationsPendingException {
    /**
     * Constructs a new <code>TooManyActivationsPendingException</code>.
     * @alias module:model/TooManyActivationsPendingException
     * @param errorMessage {String} Too many activations pending
     * @param errorName {module:model/TooManyActivationsPendingException.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        TooManyActivationsPendingException.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>TooManyActivationsPendingException</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TooManyActivationsPendingException} obj Optional instance to populate.
     * @return {module:model/TooManyActivationsPendingException} The populated <code>TooManyActivationsPendingException</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TooManyActivationsPendingException();
    ...
    /**
     * Validates the JSON data with respect to <code>TooManyActivationsPendingException</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TooManyActivationsPendingException</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TooManyActivationsPendingException.RequiredProperties) {
            if (!data[property]) {
...
TooManyActivationsPendingException.RequiredProperties = ["errorMessage", "errorName"];

/**
 * Too many activations pending
 * @member {String} errorMessage
 */
TooManyActivationsPendingException.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/TooManyActivationsPendingException.ErrorNameEnum} errorName
 */
TooManyActivationsPendingException.prototype['errorName'] = undefined;
 ...
 * @readonly
 */
TooManyActivationsPendingException['ErrorNameEnum'] = {

    /**
     * value: "TooManyActivationsPendingException"
     * @const
     */
    "TooManyActivationsPendingException": "TooManyActivationsPendingException"
};



export default TooManyActivationsPendingException;
