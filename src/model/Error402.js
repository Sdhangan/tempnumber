...
/**
 * The Error402 model module.
 * @module model/Error402
 * @version 1.3.8
 */
class Error402 {
    /**
     * Constructs a new <code>Error402</code>.
     * @alias module:model/Error402
     * @param errorMessage {String} Payment required
     * @param errorName {module:model/Error402.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        Error402.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>Error402</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Error402} obj Optional instance to populate.
     * @return {module:model/Error402} The populated <code>Error402</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Error402();
    ...
    /**
     * Validates the JSON data with respect to <code>Error402</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Error402</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Error402.RequiredProperties) {
            if (!data[property]) {
...
Error402.RequiredProperties = ["errorMessage", "errorName"];

/**
 * Payment required
 * @member {String} errorMessage
 */
Error402.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/Error402.ErrorNameEnum} errorName
 */
Error402.prototype['errorName'] = undefined;
