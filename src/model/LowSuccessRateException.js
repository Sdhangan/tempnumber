...
/**
 * The LowSuccessRateException model module.
 * @module model/LowSuccessRateException
 * @version 1.3.8
 */
class LowSuccessRateException {
    /**
     * Constructs a new <code>LowSuccessRateException</code>.
     * @alias module:model/LowSuccessRateException
     * @param errorMessage {String} Low success rate
     * @param errorName {module:model/LowSuccessRateException.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        LowSuccessRateException.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>LowSuccessRateException</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LowSuccessRateException} obj Optional instance to populate.
     * @return {module:model/LowSuccessRateException} The populated <code>LowSuccessRateException</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LowSuccessRateException();
    ...
    /**
     * Validates the JSON data with respect to <code>LowSuccessRateException</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LowSuccessRateException</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LowSuccessRateException.RequiredProperties) {
            if (!data[property]) {
...
LowSuccessRateException.RequiredProperties = ["errorMessage", "errorName"];

/**
 * Low success rate
 * @member {String} errorMessage
 */
LowSuccessRateException.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/LowSuccessRateException.ErrorNameEnum} errorName
 */
LowSuccessRateException.prototype['errorName'] = undefined;
 ...
 * @readonly
 */
LowSuccessRateException['ErrorNameEnum'] = {

    /**
     * value: "lowSuccessRateException"
     * @const
     */
    "lowSuccessRateException": "lowSuccessRateException"
};



export default LowSuccessRateException;
