...
import PriceByCountry from './PriceByCountry';

/**
 * The PricelistByCountry model module.
 * @module model/PricelistByCountry
 * @version 1.2.7
 */
class PricelistByCountry extends Array {
    /**
     * Constructs a new <code>PricelistByCountry</code>.
     * @alias module:model/PricelistByCountry
     * @extends Array
     */
    constructor() { 
        super();
        ...
        PricelistByCountry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PricelistByCountry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PricelistByCountry} obj Optional instance to populate.
     * @return {module:model/PricelistByCountry} The populated <code>PricelistByCountry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PricelistByCountry();

            ApiClient.constructFromObject(data, obj, 'PriceByCountry');
...
export default PricelistByCountry;
