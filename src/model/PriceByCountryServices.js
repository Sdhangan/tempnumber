...
/**
 * The PriceByCountryServices model module.
 * @module model/PriceByCountryServices
 * @version 1.2.7
 */
class PriceByCountryServices {
    /**
     * Constructs a new <code>PriceByCountryServices</code>.
     * @alias module:model/PriceByCountryServices
     */
    constructor() { 
        
        PriceByCountryServices.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PriceByCountryServices</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PriceByCountryServices} obj Optional instance to populate.
     * @return {module:model/PriceByCountryServices} The populated <code>PriceByCountryServices</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PriceByCountryServices();
 ...
 * @member {String} s
 */
PriceByCountryServices.prototype['s'] = undefined;

/**
 * Price
 * @member {Number} p
 */
PriceByCountryServices.prototype['p'] = undefined;
...
export default PriceByCountryServices;
