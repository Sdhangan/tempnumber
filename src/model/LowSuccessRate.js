...
/**
 * The LowSuccessRate model module.
 * @module model/LowSuccessRate
 * @version 1.2.7
 */
class LowSuccessRate {
    /**
     * Constructs a new <code>LowSuccessRate</code>.
     * @alias module:model/LowSuccessRate
     * @param errorMessage {String} Low success rate
     * @param errorName {module:model/LowSuccessRate.ErrorNameEnum} 
     */
    constructor(errorMessage, errorName) { 
        
        LowSuccessRate.initialize(this, errorMessage, errorName);
    }
    ...
    /**
     * Constructs a <code>LowSuccessRate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LowSuccessRate} obj Optional instance to populate.
     * @return {module:model/LowSuccessRate} The populated <code>LowSuccessRate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LowSuccessRate();
 ...
 */
LowSuccessRate.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/LowSuccessRate.ErrorNameEnum} errorName
 */
LowSuccessRate.prototype['errorName'] = undefined;
