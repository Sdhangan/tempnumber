...
/**
 * The ActivationHistory model module.
 * @module model/ActivationHistory
 * @version 1.2.7
 */
class ActivationHistory {
    /**
     * Constructs a new <code>ActivationHistory</code>.
     * @alias module:model/ActivationHistory
     */
    constructor() { 
        
        ActivationHistory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActivationHistory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActivationHistory} obj Optional instance to populate.
     * @return {module:model/ActivationHistory} The populated <code>ActivationHistory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActivationHistory();
 ...
 */
ActivationHistory.prototype['activations'] = undefined;

/**
 * Selected page
 * @member {Number} page
 */
ActivationHistory.prototype['page'] = undefined;

/**
 * Items limit per page
 * @member {Number} limit
 */
ActivationHistory.prototype['limit'] = undefined;

/**
 * Total pages count
 * @member {Number} pages
 */
ActivationHistory.prototype['pages'] = undefined;

/**
 * Total records found
 * @member {Number} total
 */
ActivationHistory.prototype['total'] = undefined;
