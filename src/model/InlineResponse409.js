...
class InlineResponse409 {
     ...
     * @param errorName {module:model/InlineResponse409.ErrorNameEnum} 
     * @param newPrice {Number} The value of the new price
     */
    constructor(errorMessage, errorName, newPrice) { 
        
        InlineResponse409.initialize(this, errorMessage, errorName, newPrice);
    }
 ...
 */
InlineResponse409.prototype['errorMessage'] = undefined;

/**
 * @member {module:model/InlineResponse409.ErrorNameEnum} errorName
 */
InlineResponse409.prototype['errorName'] = undefined;

/**
 * The value of the new price
 * @member {Number} newPrice
 */
InlineResponse409.prototype['newPrice'] = undefined;
 ...
 * @readonly
 */
InlineResponse409['ErrorNameEnum'] = {
