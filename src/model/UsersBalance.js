...
/**
 * The UsersBalance model module.
 * @module model/UsersBalance
 * @version 1.2.7
 */
class UsersBalance {
    /**
     * Constructs a new <code>UsersBalance</code>.
     * @alias module:model/UsersBalance
     */
    constructor() { 
        
        UsersBalance.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UsersBalance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UsersBalance} obj Optional instance to populate.
     * @return {module:model/UsersBalance} The populated <code>UsersBalance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsersBalance();
 ...
 */
UsersBalance.prototype['balance'] = undefined;
