...
/**
 * The ActivationNumber model module.
 * @module model/ActivationNumber
 * @version 1.2.7
 */
class ActivationNumber {
    /**
     * Constructs a new <code>ActivationNumber</code>.
     * @alias module:model/ActivationNumber
    ...
    constructor(countryId, serviceId) { 
        ...
        ActivationNumber.initialize(this, countryId, serviceId);
    }
    ...
    /**
     * Constructs a <code>ActivationNumber</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActivationNumber} obj Optional instance to populate.
     * @return {module:model/ActivationNumber} The populated <code>ActivationNumber</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActivationNumber();
 ...
 */
ActivationNumber.prototype['countryId'] = undefined;

/**
 * Service Id. e.g. Facebook, Viber, Whatsapp, etc.
 * @member {String} serviceId
 */
ActivationNumber.prototype['serviceId'] = undefined;

/**
 * Expected price
 * @member {Number} expectedPrice
 */
ActivationNumber.prototype['expectedPrice'] = undefined;
