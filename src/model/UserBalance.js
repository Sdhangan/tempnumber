...
/**
 * The UserBalance model module.
 * @module model/UserBalance
 * @version 1.3.8
 */
class UserBalance {
    /**
     * Constructs a new <code>UserBalance</code>.
     * @alias module:model/UserBalance
     */
    constructor() { 
        
        UserBalance.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserBalance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserBalance} obj Optional instance to populate.
     * @return {module:model/UserBalance} The populated <code>UserBalance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserBalance();

            if (data.hasOwnProperty('balance')) {
                obj['balance'] = ApiClient.convertToType(data['balance'], 'Number');
            }
            if (data.hasOwnProperty('review_balance')) {
                obj['review_balance'] = ApiClient.convertToType(data['review_balance'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserBalance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserBalance</code>.
     */
 ...
 */
UserBalance.prototype['balance'] = undefined;

/**
 * Balance in review
 * @member {Number} review_balance
 */
UserBalance.prototype['review_balance'] = undefined;
