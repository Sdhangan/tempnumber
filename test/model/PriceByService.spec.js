...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.PriceByService();
  });
  ...
  describe('PriceByService', function() {
    it('should create an instance of PriceByService', function() {
      // uncomment below and update the code to test PriceByService
      //var instane = new Tempnumber.PriceByService();
      //expect(instance).to.be.a(Tempnumber.PriceByService);
    });

    it('should have the property s (base name: "s")', function() {
      // uncomment below and update the code to test the property s
      //var instance = new Tempnumber.PriceByService();
