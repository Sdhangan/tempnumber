...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.ActivationNumber();
  });
  ...
  describe('ActivationNumber', function() {
    it('should create an instance of ActivationNumber', function() {
      // uncomment below and update the code to test ActivationNumber
      //var instane = new Tempnumber.ActivationNumber();
      //expect(instance).to.be.a(Tempnumber.ActivationNumber);
    });
    ...
    it('should have the property countryId (base name: "countryId")', function() {
      ...
      //var instance = new Tempnumber.ActivationNumber();
