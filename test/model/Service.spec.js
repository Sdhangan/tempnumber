...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.Service();
  });
  ...
  describe('Service', function() {
    it('should create an instance of Service', function() {
      ...
      //var instance = new Tempnumber.Service();
      //expect(instance).to.be.a(Tempnumber.Service);
    });
    ...
    it('should have the property hasNumbers (base name: "hasNumbers")', function() {
      // uncomment below and update the code to test the property hasNumbers
      //var instance = new Tempnumber.Service();
      //expect(instance).to.be();
    });
