...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.Error409();
  });
  ...
  describe('Error409', function() {
    it('should create an instance of Error409', function() {
      // uncomment below and update the code to test Error409
      //var instance = new Tempnumber.Error409();
      //expect(instance).to.be.a(Tempnumber.Error409);
    });
