...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.PriceByCountry();
  });
  ...
  describe('PriceByCountry', function() {
    it('should create an instance of PriceByCountry', function() {
      // uncomment below and update the code to test PriceByCountry
      //var instance = new Tempnumber.PriceByCountry();
      //expect(instance).to.be.a(Tempnumber.PriceByCountry);
    });
