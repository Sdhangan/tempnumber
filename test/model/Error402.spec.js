...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.Error402();
  });
  ...
  describe('Error402', function() {
    it('should create an instance of Error402', function() {
      // uncomment below and update the code to test Error402
      //var instance = new Tempnumber.Error402();
      //expect(instance).to.be.a(Tempnumber.Error402);
    });
