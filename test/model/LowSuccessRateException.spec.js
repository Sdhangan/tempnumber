...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.LowSuccessRateException();
  });
  ...
  describe('LowSuccessRateException', function() {
    it('should create an instance of LowSuccessRateException', function() {
      // uncomment below and update the code to test LowSuccessRateException
      //var instance = new Tempnumber.LowSuccessRateException();
      //expect(instance).to.be.a(Tempnumber.LowSuccessRateException);
    });
