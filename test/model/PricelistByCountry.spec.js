...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.PricelistByCountry();
  });
  ...
  describe('PricelistByCountry', function() {
    it('should create an instance of PricelistByCountry', function() {
      // uncomment below and update the code to test PricelistByCountry
      //var instane = new Tempnumber.PricelistByCountry();
      //expect(instance).to.be.a(Tempnumber.PricelistByCountry);
    });
