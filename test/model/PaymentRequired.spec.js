...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.PaymentRequired();
  });
  ...
  describe('PaymentRequired', function() {
    it('should create an instance of PaymentRequired', function() {
      // uncomment below and update the code to test PaymentRequired
      //var instane = new Tempnumber.PaymentRequired();
      //expect(instance).to.be.a(Tempnumber.PaymentRequired);
    });

    it('should have the property errorMessage (base name: "errorMessage")', function() {
      // uncomment below and update the code to test the property errorMessage
      //var instance = new Tempnumber.PaymentRequired();
