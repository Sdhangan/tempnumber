...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.TooManyActivationsPendingException();
  });
  ...
  describe('TooManyActivationsPendingException', function() {
    it('should create an instance of TooManyActivationsPendingException', function() {
      // uncomment below and update the code to test TooManyActivationsPendingException
      //var instance = new Tempnumber.TooManyActivationsPendingException();
      //expect(instance).to.be.a(Tempnumber.TooManyActivationsPendingException);
    });
