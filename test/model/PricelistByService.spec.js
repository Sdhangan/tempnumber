...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.PricelistByService();
  });
  ...
  describe('PricelistByService', function() {
    it('should create an instance of PricelistByService', function() {
      // uncomment below and update the code to test PricelistByService
      //var instane = new Tempnumber.PricelistByService();
      //expect(instance).to.be.a(Tempnumber.PricelistByService);
    });
