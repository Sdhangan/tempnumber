...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.BadRequest();
  });
  ...
  describe('BadRequest', function() {
    it('should create an instance of BadRequest', function() {
      ...
      //var instane = new Tempnumber.BadRequest();
      //expect(instance).to.be.a(Tempnumber.BadRequest);
    });

    it('should have the property errorMessage (base name: "errorMessage")', function() {
      // uncomment below and update the code to test the property errorMessage
      //var instance = new Tempnumber.BadRequest();
