...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.InlineResponse409();
  });
  ...
  describe('InlineResponse409', function() {
    it('should create an instance of InlineResponse409', function() {
      ...
      //var instane = new Tempnumber.InlineResponse409();
      //expect(instance).to.be.a(Tempnumber.InlineResponse409);
    });

    it('should have the property errorMessage (base name: "errorMessage")', function() {
      // uncomment below and update the code to test the property errorMessage
      //var instance = new Tempnumber.InlineResponse409();
