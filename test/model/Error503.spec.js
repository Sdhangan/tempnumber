...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.Error503();
  });
  ...
  describe('Error503', function() {
    it('should create an instance of Error503', function() {
      // uncomment below and update the code to test Error503
      //var instance = new Tempnumber.Error503();
      //expect(instance).to.be.a(Tempnumber.Error503);
    });
