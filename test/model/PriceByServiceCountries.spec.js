...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.PriceByServiceCountries();
  });
  ...
  describe('PriceByServiceCountries', function() {
    it('should create an instance of PriceByServiceCountries', function() {
      // uncomment below and update the code to test PriceByServiceCountries
      //var instane = new Tempnumber.PriceByServiceCountries();
      //expect(instance).to.be.a(Tempnumber.PriceByServiceCountries);
    });

    it('should have the property c (base name: "c")', function() {
      // uncomment below and update the code to test the property c
      //var instance = new Tempnumber.PriceByServiceCountries();
