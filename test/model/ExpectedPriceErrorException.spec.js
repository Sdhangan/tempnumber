...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.ExpectedPriceErrorException();
  });
  ...
  describe('ExpectedPriceErrorException', function() {
    it('should create an instance of ExpectedPriceErrorException', function() {
      // uncomment below and update the code to test ExpectedPriceErrorException
      //var instance = new Tempnumber.ExpectedPriceErrorException();
      //expect(instance).to.be.a(Tempnumber.ExpectedPriceErrorException);
    });
