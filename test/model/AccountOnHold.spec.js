...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.AccountOnHold();
  });
  ...
  describe('AccountOnHold', function() {
    it('should create an instance of AccountOnHold', function() {
      // uncomment below and update the code to test AccountOnHold
      //var instane = new Tempnumber.AccountOnHold();
      //expect(instance).to.be.a(Tempnumber.AccountOnHold);
    });

    it('should have the property errorMessage (base name: "errorMessage")', function() {
      // uncomment below and update the code to test the property errorMessage
      //var instance = new Tempnumber.AccountOnHold();
