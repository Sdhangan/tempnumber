...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.ActivationsHistory();
  });
  ...
  describe('ActivationsHistory', function() {
    it('should create an instance of ActivationsHistory', function() {
      // uncomment below and update the code to test ActivationsHistory
      //var instance = new Tempnumber.ActivationsHistory();
      //expect(instance).to.be.a(Tempnumber.ActivationsHistory);
    });

    it('should have the property activations (base name: "activations")', function() {
      // uncomment below and update the code to test the property activations
      //var instance = new Tempnumber.ActivationsHistory();
