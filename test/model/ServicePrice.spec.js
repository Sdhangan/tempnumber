...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.ServicePrice();
  });
  ...
  describe('ServicePrice', function() {
    it('should create an instance of ServicePrice', function() {
      // uncomment below and update the code to test ServicePrice
      //var instance = new Tempnumber.ServicePrice();
      //expect(instance).to.be.a(Tempnumber.ServicePrice);
    });
