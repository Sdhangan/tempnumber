...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.ActivationData();
  });
  ...
  describe('ActivationData', function() {
    it('should create an instance of ActivationData', function() {
      // uncomment below and update the code to test ActivationData
      //var instance = new Tempnumber.ActivationData();
      //expect(instance).to.be.a(Tempnumber.ActivationData);
    });
    ...
    it('should have the property countryIconPath (base name: "countryIconPath")', function() {
      // uncomment below and update the code to test the property countryIconPath
      //var instance = new Tempnumber.ActivationData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property serviceIconPath (base name: "serviceIconPath")', function() {
      // uncomment below and update the code to test the property serviceIconPath
      //var instance = new Tempnumber.ActivationData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property formatNumber (base name: "formatNumber")', function() {
      // uncomment below and update the code to test the property formatNumber
      //var instance = new Tempnumber.ActivationData();
      //expect(instance).to.be();
    });

    it('should have the property nationalNumber (base name: "nationalNumber")', function() {
      // uncomment below and update the code to test the property nationalNumber
      //var instance = new Tempnumber.ActivationData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numberExpireAt (base name: "numberExpireAt")', function() {
      // uncomment below and update the code to test the property numberExpireAt
      //var instance = new Tempnumber.ActivationData();
      //expect(instance).to.be();
    });

    it('should have the property utc (base name: "utc")', function() {
      // uncomment below and update the code to test the property utc
      //var instance = new Tempnumber.ActivationData();
      //expect(instance).to.be();
    });

    it('should have the property retryAvailable (base name: "retryAvailable")', function() {
      // uncomment below and update the code to test the property retryAvailable
      //var instance = new Tempnumber.ActivationData();
      //expect(instance).to.be();
    });
