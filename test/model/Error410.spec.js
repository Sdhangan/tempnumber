...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.Error410();
  });
  ...
  describe('Error410', function() {
    it('should create an instance of Error410', function() {
      // uncomment below and update the code to test Error410
      //var instance = new Tempnumber.Error410();
      //expect(instance).to.be.a(Tempnumber.Error410);
    });
