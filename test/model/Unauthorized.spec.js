...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.Unauthorized();
  });
  ...
  describe('Unauthorized', function() {
    it('should create an instance of Unauthorized', function() {
      ...
      //var instane = new Tempnumber.Unauthorized();
      //expect(instance).to.be.a(Tempnumber.Unauthorized);
    });

    it('should have the property errorMessage (base name: "errorMessage")', function() {
      // uncomment below and update the code to test the property errorMessage
      //var instance = new Tempnumber.Unauthorized();
