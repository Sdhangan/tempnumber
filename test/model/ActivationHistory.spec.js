...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.ActivationHistory();
  });
  ...
  describe('ActivationHistory', function() {
    it('should create an instance of ActivationHistory', function() {
      // uncomment below and update the code to test ActivationHistory
      //var instane = new Tempnumber.ActivationHistory();
      //expect(instance).to.be.a(Tempnumber.ActivationHistory);
    });
    ...
    it('should have the property activations (base name: "activations")', function() {
      ...
      //var instance = new Tempnumber.ActivationHistory();
