...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.TooManyActivationsPending();
  });
  ...
  describe('TooManyActivationsPending', function() {
    it('should create an instance of TooManyActivationsPending', function() {
      // uncomment below and update the code to test TooManyActivationsPending
      //var instane = new Tempnumber.TooManyActivationsPending();
      //expect(instance).to.be.a(Tempnumber.TooManyActivationsPending);
    });

    it('should have the property errorMessage (base name: "errorMessage")', function() {
      // uncomment below and update the code to test the property errorMessage
      //var instance = new Tempnumber.TooManyActivationsPending();
