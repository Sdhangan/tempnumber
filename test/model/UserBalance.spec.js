...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.UserBalance();
  });
  ...
  describe('UserBalance', function() {
    it('should create an instance of UserBalance', function() {
      // uncomment below and update the code to test UserBalance
      //var instance = new Tempnumber.UserBalance();
      //expect(instance).to.be.a(Tempnumber.UserBalance);
    });
    ...
    it('should have the property reviewBalance (base name: "review_balance")', function() {
      // uncomment below and update the code to test the property reviewBalance
      //var instance = new Tempnumber.UserBalance();
      //expect(instance).to.be();
    });
