...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.UsersBalance();
  });
  ...
  describe('UsersBalance', function() {
    it('should create an instance of UsersBalance', function() {
      // uncomment below and update the code to test UsersBalance
      //var instane = new Tempnumber.UsersBalance();
      //expect(instance).to.be.a(Tempnumber.UsersBalance);
    });

    it('should have the property balance (base name: "balance")', function() {
      // uncomment below and update the code to test the property balance
      //var instance = new Tempnumber.UsersBalance();
