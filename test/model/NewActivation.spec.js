...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.NewActivation();
  });
  ...
  describe('NewActivation', function() {
    it('should create an instance of NewActivation', function() {
      // uncomment below and update the code to test NewActivation
      //var instance = new Tempnumber.NewActivation();
      //expect(instance).to.be.a(Tempnumber.NewActivation);
    });
    ...
    it('should have the property expectedPrice (base name: "expectedPrice")', function() {
      // uncomment below and update the code to test the property expectedPrice
      //var instance = new Tempnumber.NewActivation();
      //expect(instance).to.be();
    });
