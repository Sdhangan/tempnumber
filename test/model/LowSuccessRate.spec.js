...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.LowSuccessRate();
  });
  ...
  describe('LowSuccessRate', function() {
    it('should create an instance of LowSuccessRate', function() {
      // uncomment below and update the code to test LowSuccessRate
      //var instane = new Tempnumber.LowSuccessRate();
      //expect(instance).to.be.a(Tempnumber.LowSuccessRate);
    });

    it('should have the property errorMessage (base name: "errorMessage")', function() {
      // uncomment below and update the code to test the property errorMessage
      //var instance = new Tempnumber.LowSuccessRate();
