...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.InlineResponse4091();
  });
  ...
  describe('InlineResponse4091', function() {
    it('should create an instance of InlineResponse4091', function() {
      // uncomment below and update the code to test InlineResponse4091
      //var instane = new Tempnumber.InlineResponse4091();
      //expect(instance).to.be.a(Tempnumber.InlineResponse4091);
    });

    it('should have the property errorMessage (base name: "errorMessage")', function() {
      // uncomment below and update the code to test the property errorMessage
      //var instance = new Tempnumber.InlineResponse4091();
