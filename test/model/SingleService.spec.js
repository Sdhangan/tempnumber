...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.SingleService();
  });
  ...
  describe('SingleService', function() {
    it('should create an instance of SingleService', function() {
      // uncomment below and update the code to test SingleService
      //var instance = new Tempnumber.SingleService();
      //expect(instance).to.be.a(Tempnumber.SingleService);
    });
