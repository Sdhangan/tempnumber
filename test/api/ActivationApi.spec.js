...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.ActivationApi();
  });
  ...
  describe('ActivationApi', function() {
    describe('getActivation', function() {
      it('should call getActivation successfully', function(done) {
        //uncomment below and update the code to test getActivation
        //instance.getActivation(function(error) {
    ...
    describe('getActivationsHistory', function() {
      it('should call getActivationsHistory successfully', function(done) {
        //uncomment below and update the code to test getActivationsHistory
        //instance.getActivationsHistory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('newActivation', function() {
      it('should call newActivation successfully', function(done) {
        //uncomment below and update the code to test newActivation
        //instance.newActivation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateActivation', function() {
      it('should call updateActivation successfully', function(done) {
        //uncomment below and update the code to test updateActivation
        //instance.updateActivation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
