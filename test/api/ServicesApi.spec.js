...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tempnumber.ServicesApi();
  });
  ...
  describe('ServicesApi', function() {
    describe('getPricelistByCountry', function() {
      it('should call getPricelistByCountry successfully', function(done) {
        //uncomment below and update the code to test getPricelistByCountry
        //instance.getPricelistByCountry(function(error) {
    ...
    describe('getPricelistByService', function() {
      it('should call getPricelistByService successfully', function(done) {
        //uncomment below and update the code to test getPricelistByService
        //instance.getPricelistByService(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSingleService', function() {
      it('should call getSingleService successfully', function(done) {
        //uncomment below and update the code to test getSingleService
        //instance.getSingleService(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
